  ...
  for i = 1:size([u, v], 1)
      ...
      if u(i) > v(i)
          ...
          elseif strcmp(TransName, 'MHSwendsenWang2')
              ...
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              up=0;
              uwhere=find(edge_factor.var==u(i));
              vwhere=find(edge_factor.var==v(i));
              for kkk=1:edge_factor.card(uwhere)
                  up=up+GetValueOfAssignment(edge_factor,[kkk,kkk]);
              end
              down=sum(edge_factor.val);
              q_ij=up/down;
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          else
