  ...
  for i = 1:size([u, v], 1)
      ...
      if u(i) > v(i)
          ...
          elseif strcmp(TransName, 'MHSwendsenWang2')
              ...
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              num_var = length(edge_factor.var);
              vec_assign = [1:edge_factor.card(1)]';
              assignments = repmat(vec_assign, 1, num_var);
              indexes = AssignmentToIndex(assignments, edge_factor.card);
              q_ij = sum(edge_factor.val(indexes))/sum(edge_factor.val(:));
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          else
