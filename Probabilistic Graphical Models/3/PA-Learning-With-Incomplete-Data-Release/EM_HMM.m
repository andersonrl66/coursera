...
for iter=1:maxIter
  ...
  P.c = ComputePc_HMM(ClassProb,actionData);
  P.clg = ComputePclg(poseData, G, ClassProb);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  P.transMatrix = ComputePtransMatrix(PairProb);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  logEmissionProb = ComputeLikelihood(P, G, poseData,true);
  ...
  [PairProb loglikelihood ClassProb] = ComputePairProb(actionData,P,logEmissionProb,loglikelihood,ClassProb, iter);
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
