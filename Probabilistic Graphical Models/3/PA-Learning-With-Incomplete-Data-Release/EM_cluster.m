...
for iter=1:maxIter
  ...
  ClassProb = ComputeLikelihood(P, G, poseData,false);

  somaProb=logsumexp(ClassProb);
  for j=1:K
      ClassProb(:,j)=ClassProb(:,j)-somaProb;
  end
  ...
  % YOUR CODE HERE
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  loglikelihood(iter)=sum(somaProb);  
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
