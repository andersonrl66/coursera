...
[PActions loglikelihoods ClassProbs PairProbs] = TrainModel(datasetTrain, G, maxIter);
...
% YOUR CODE HERE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[predicted_labels accuracy] = ClassifyDataset(datasetTest, PActions, ClassProbs, G);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
